...
function fn_tiviclick_settings() {
	...
	if(isset($_POST['actidsubmit'])) {
		...
		$use_lang = (isset($_POST['lang_tiviclick']))?intval($_POST['lang_tiviclick']):0;
				...
				<tbody>
				  ...
				  <tr valign="top">
					...
					<td>
					  ...
					  <p class="description">When the checkbox is checked, Tiviclick plugin will use the language according to the Site's locale <br /> Otherwise, Tiviclick plugin will use the language defined in your Tiviclick account.<br>
