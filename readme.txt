...
Welcome to <a href="http://www.tiviclick.com">Tiviclick</a> Video Chats for WordPress websites.

This plugin integrates Tiviclick Video Chat widget with your WordPress website.
...
<strong>Business that can benefit by using Tiviclick Video Chat:</strong>
<ul>
<li>E-Commerce websites.</li>
<li>Professional Directories.</li>
<li>Service providers: Lawyers, Doctors, Therapists, Coaches, Consultants.</li>
<li>Agents: Sales, Support, Insurance, Real Estate.</li>
<li>Job Recruiters in organizations and businesses.</li>
<li>Social networks, organizations networks.</li>
<li>Dating websites.</li>
</ul>

<strong>What you can do with Tiviclick:</strong>
<ul>
<li>Close more deals.</li>
<li>Accelerate your sales revenues by creating personal contacts with your customers.</li>
<li>Upgrade your customer's support level through face to face video chat.</li>
...
<strong>Tiviclick's Main Features:</strong>
<ul>
<li>Non-registered visitor can chat with business Agent.</li>
<li>Each side can select using Video, Audio, Text Chat.</li>
<li>Agent registration in your site or in your Tiviclick account.</li>
...
<ul>
<li>WebRTC with fallback to Flash.</li>
<li>Configure your chat widget option.</li>
<li>API for customer support mode.</li>
<li>API for Social Network / Dating / Buddypress mode.</li>
<li>Agent's Android App.</li>
</ul>


<strong>Service:</strong>
<ul>
<li>Full service through Tiviclick's servers.</li>
<li>E-Mail support by <a href="mailto:support@tiviclick.com">support@tiviclick.com</a></li>
</ul>
...
<ul>
<li>See <a href="http://tiviclick.com/docs/TiviClick_operqtion_guide-English.pdf">http://tiviclick.com/docs/TiviClick_operqtion_guide-English.pdf</a></li>
</ul>
...
1.	Login to your WordPress website as administrator.<br />
2.	Go to plugins page from admin panel.<br />
3.	Click on "Add New" link/button.<br />
4.	Search "Tiviclick" in search bar at top and press enter.<br />
5.	Result will show "Tiviclick" plugin where you can use "Install Now" option to install it in website.<br />
6.  Click the Activate Plugin link on the plugins page.

<strong>For manual installation 1:</strong><br /> 
1.	Click <a href="https://downloads.wordpress.org/plugin/tiviclick-live-video-chat.2.0.zip">here</a> to download the file.<br />
2.	Login to your website and go to the plugins section of your admin panel.<br />
3.	Click the Add New button.<br />
4.	Under Install Plugins, click the Upload link.<br />
...
3.	In case of cPanel, copy the plugin zip file (tiviclick-live-video-chat.zip) up to your server, unzip it somewhere on the file system and copy the "tiviclick-live-video-chat" folder into the /wp-content/plugins directory of your WordPress installation.<br />
4.	In case of FTP, upload the "tiviclick-live-video-chat" folder directly to /wp-content/plugins directory of your WordPress website.<br />
5.	Login to your website and go to the Plugins section of your admin panel.<br />
6.	Look for "TiviClick" and click Activate.

<strong>Plugin Settings</strong><br />
1.	Once the plugin have been successfully activated, you will see "TiviClick Settings" in left navigation.<br />
2.	Click on "TiviClick Settings" link and it will prompt a settings page where you need to put a TiviClick account Id.
3.	TiviClick account Id can be retrieved from TiviClick website your account admin.<br />
4.	If you have already registered on TiviClick website then login to account or click <a href="http://tiviclick.com/admin/login.php#create">here</a> to register.<br />
5.	After log into the TiviClick website and click "Account" in left bar. Look for "Account Code".<br />
6.	Copy & paste the same account code in your "TiviClick Settings" page in WordPress admin panel and click save button to complete process.<br />
7.	You are done!
